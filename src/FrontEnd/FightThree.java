        ...
        for (Character c : characters)
        {
            ...
            attackBtn.addActionListener(e ->
            {
                if (c.HP > 0) {
                    ...
                    showBattleText("Finals Monster took " + damage + " damage!");
                } else {
            ...
            ultBtn.addActionListener(e ->
            {
                if(c.name.equals("Quinn"))
                {
                    ...
                    if (c.MP >= c.skill1.MPcost && c.HP > 0) {
                        ...
                        showBattleText("CRITICAL HIT! Finals Monster took " + damage + " damage!");
                    } else if (c.HP <= 0) {
                        showBattleText(c.getName() + " is down!");
                    } else {
                        showBattleText("Not enough MP!");
    ...
    private void showDialogue(String characterName, String action) {
        ...
        if (charIndex != -1) {
            ...
            String monsterSay = switch (action) {
                ...
                case "SKILL" -> "You'll have to retake this semester!";
