...
class FightTwo extends JPanel implements ActionListener {
    ...
    private JLabel createMonsterImage(String monsterName) {
        ...
        String path = "C:/Users/User/CODE_JAVA/GUI 3 - Final/GUI 3/GUI/images/HomeworkMonsterTwo.png";
        ...
        for (Character c : characters)
        {
            ...
            attackBtn.addActionListener(e ->
            {
                if (c.HP > 0) {
                    ...
                    showBattleText("Midterm Monster took " + damage + " damage!");
                } else {
            ...
            ultBtn.addActionListener(e ->
            {
                if(c.name.equals("Quinn"))
                {
                    ...
                    if (c.MP >= c.skill1.MPcost && c.HP > 0) {
                        ...
                        MP();
                        showDialogue(c.getName(), "ULTIMATE");
                        showBattleText("CRITICAL HIT! Midterm Monster took " + damage + " damage!");
                    } else if (c.HP <= 0) {
                        showBattleText(c.getName() + " is down!");
                    } else {
                        showBattleText("Not enough MP!");
            ...
            switch (characterName) {
                ...
                case "Dorothy" -> {
                    dialogue = switch (action) {
                        ...
                        case "ULTIMATE" -> "Grand architectural annihilation!";
                        default -> dialogue;
                    };
                }
                case "Quinn" -> {
